...
export default function Dashbord() {
  ...
  return (
    <div>
      <div className="flex fixed inset-0 h-screen bg-gray-200">
        <div
        ...
        <div
          className={ isSidebarOpen 
            ? 'translate-x-0 ease-out fixed z-20 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0' 
            : '-translate-x-full ease-in fixed inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0'
         } 
        >
