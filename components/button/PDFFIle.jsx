...
export default function PDFFile({ data, name, keyword }) {
  ...
  return (
    <div
      id="page"
      className="text-gray-800 bg-white text-xs fixed inset-0 border-0"
    >
      <div className="mb-6" id="title-table">
      ...
      >
        <thead className="bg-gray-300 break-words">
          <tr className="" style={{ breakInside: "avoid" }}>
            ...
            <th
              className="border border-collapse border-gray-500 p1 w-3/12 "
